...
data class Fetch1Response(
    ...
    data class DataInfo(
        ...
        @ProtoNumber(19) val TypesTypes: List<TypeItem> = emptyList(),
        @ProtoNumber(20) val Status: List<TypeItem> = emptyList(),
        @ProtoNumber(21) val Authors: List<TypeItem> = emptyList(),
        @ProtoNumber(22) val SubscribeNum: Int? = null,
        @ProtoNumber(23) val Chapters: List<Chapter> = emptyList(),
        ...
        data class Chapter(
            ...
            @ProtoNumber(2) val Data: List<ChapterInfo> = emptyList(),
        ) {
